 ...
 */
@Wire
class ServerNetworkSystemOld(private val gameWorld: GameWorld, private val gameServer: GameServer) : BaseSystem() {


    companion object {
        val log = logger<ServerNetworkSystemOld>()
    }
...
//class ServerNetworkSystemOld : IteratingSystem(allOf(NetworkComponent::class).get()) {
//
